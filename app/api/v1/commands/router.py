...
async def enqueue(body: CommandIn, svc: Annotated[CommandService, Depends(get_service)]) -> CommandOut:
...
async def get_one(cmd_id: str, svc: Annotated[CommandService, Depends(get_service)]) -> CommandOut | None:
